    ...
    >
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4 sm:px-8">
        <Link to="/" className="group flex items-center gap-3" aria-label="面签 AI Coach 首页">
          <span className="flex h-10 w-10 items-center justify-center rounded-[14px] bg-[#1d1d1f] text-white shadow-lg shadow-black/10 transition-transform duration-300 group-hover:scale-[1.03]">
        ...
        <Link to="/voice" className="app-button-secondary min-h-10 px-4 py-2 text-[13px]">
          开始练习
