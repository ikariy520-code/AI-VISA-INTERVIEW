...
export type B2OfficialRuleId = typeof B2_OFFICIAL_CRITERIA[number]['id']
export const B2_OFFICIAL_RULE_IDS = new Set<B2OfficialRuleId>(B2_OFFICIAL_CRITERIA.map(rule => rule.id))
